...
import usage_monitor_for_copilot.platforms.instance_linux as si  # noqa: E402
...
class TestLockPath(unittest.TestCase):
    ...
    def test_config_dir_gets_own_lock(self):
        ...
        with patch.object(si, '_lock_directory', return_value=Path('/run')), \
            ...
            self.assertEqual(si._lock_path(), Path('/run/usage-monitor-for-copilot-abc.lock'))
...
class TestEnsureSingleInstance(_LockTestCase):
    ...
    def test_replace_terminates_holder_and_retakes(self):
        ...
        self.directory.joinpath('usage-monitor-for-copilot.lock').write_text('4242\n9.9.9\n', encoding='utf-8')
    ...
    def test_recycled_pid_is_not_terminated(self):
        ...
        def rewrite_holder():
            self.directory.joinpath('usage-monitor-for-copilot.lock').write_text('5555\n9.9.9\n', encoding='utf-8')
            return True
...
class TestHolderRecord(_LockTestCase):
    ...
    def test_empty_file(self):
        ...
        self.directory.joinpath('usage-monitor-for-copilot.lock').write_text('', encoding='utf-8')
        self.assertEqual(si._read_holder_info(), (None, None))

    def test_malformed_pid(self):
        """A non-numeric first line is ignored rather than raising."""
        self.directory.joinpath('usage-monitor-for-copilot.lock').write_text('not-a-pid\n1.0\n', encoding='utf-8')
        self.assertEqual(si._read_holder_info(), (None, None))
    ...
    def test_zero_pid_is_no_holder_but_keeps_version(self):
        ...
        """
        self.directory.joinpath('usage-monitor-for-copilot.lock').write_text('0\n1.0\n', encoding='utf-8')
    ...
    def test_write_truncates_previous_record(self):
        ...
        path = self.directory / 'usage-monitor-for-copilot.lock'
